...
}).min(1); // At least one field required for update// ❌ لا تتحقق من content_url داخل Joi إذا كانت video
...
export const createLessonSchema = Joi.object({
  ...
  content_url: Joi.when("content_type", {
    is: "video",
    then: Joi.string().uri().optional(), // optional لأننا بنضيفه لاحقاً بعد رفع الفيديو
